    ...
    <div class="flex justify-center items-center min-h-screen">
        ...
        <div class="w-full md:w-80 p-6 shadow-lg shadow-neutral-800 rounded-lg">
            ...
            <form wire:submit="cadastrar">
                ...
                <p class="text-2xl font-semibold text-center text-stone-700">Cadastre-se</p>

                <x-text-input model="name" label="Nome:" classe="border-none bg-gray-200" />

                <x-text-input model="email" label="E-mail:" type="email" classe="border-none bg-gray-200" />

                <x-text-input model="password_confirmation" label="Senha:" type="password" classe="border-none bg-gray-200" />

                <x-text-input model="password" label="Confirme a senha:" type="password" classe="border-none bg-gray-200" />

                <x-button-princ text="Cadastrar" load="cadastrar" class="mt-4 mb-0"/>
